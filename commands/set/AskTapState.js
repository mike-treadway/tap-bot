...
AskTapState.prototype.process = async function(message) {
    ...
    if (!_.isNaN(tap)) {
        if (tap < 1 || tap > 8){
            message.channel.send("The tap number must be between 1 and 8. Please try again or type 'cancel':");
        } else{
        ...
        if (message.content == "cancel"){
            ...
            message.channel.send("That wasn't a tap number. Please try again or type 'cancel':");            
        }
    }
